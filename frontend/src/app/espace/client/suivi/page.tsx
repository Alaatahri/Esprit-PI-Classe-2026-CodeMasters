          ...
          {projects.map((p) => (
            <li key={p._id}>
              <Link
                ...
                className="group flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 px-4 py-4 transition hover:border-amber-500/30 hover:bg-white/[0.07]"
              >
