    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 sm:py-24">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-400 flex items-center justify-center mx-auto mb-8">
            <ShoppingCart className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4">Marketplace B2B</h1>
          <p className="text-gray-400 mb-8">
            Catalogue digital de matériaux et équipements. Cette section sera bientôt disponible.
          </p>
          <Link
            href="/login"
